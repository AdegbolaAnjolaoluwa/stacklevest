        ...
        <div className="flex flex-col items-center justify-center p-8 pb-6 text-center">
             ...
             <div className="space-y-3">
                 ...
                 <DialogTitle className="text-xl font-bold text-white px-4">
                    Are you sure you want to delete <span className="text-red-500">{userName || "this user"}</span>?
                 </DialogTitle>
                 <DialogDescription className="text-sm text-[#9ca3af] leading-relaxed px-2">
                    This action cannot be undone and the user will be permanently removed from the workspace.
                 </DialogDescription>
             </div>
        </div>
