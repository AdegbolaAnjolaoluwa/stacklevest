  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-500 bg-slate-100 hover:bg-slate-200 rounded-md transition-colors border border-transparent hover:border-slate-300 w-full max-w-[200px]"
      >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="p-0 overflow-hidden border-none shadow-2xl sm:max-w-[550px]">
          <Command className="flex h-full w-full flex-col overflow-hidden rounded-md bg-white">
            <div className="flex items-center border-b border-slate-100 px-4 py-3" cmdk-input-wrapper="">
            ...
            <div className="flex items-center border-t border-slate-100 px-4 py-2 text-[10px] text-slate-400">
