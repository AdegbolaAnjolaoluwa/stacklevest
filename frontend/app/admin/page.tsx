  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 mt-1">Real-time overview of your team's productivity.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-sm border-slate-200">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900">{totalMembersCount}</div>
        ...
        <Card className="shadow-sm border-slate-200">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900">{activeTasksCount}</div>
            <p className="text-xs text-slate-500 font-medium mt-1 flex items-center">
